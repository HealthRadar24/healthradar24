...
If you discover a security vulnerability in HealthRadar24, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [HealthRadar24 private vulnerability reporting](https://github.com/HealthRadar24/healthradar24/security/advisories/new) to submit your report directly to the fork operators.

2. **Upstream vulnerabilities**: If the issue is proven to affect unmodified upstream WorldMonitor code, coordinate disclosure with the upstream project after reporting it privately to HealthRadar24.
...
HealthRadar24 is a forked intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Vulnerabilities in the HealthRadar24 deployment or fork-specific code
...
Thank you for helping keep HealthRadar24 and its users safe.
