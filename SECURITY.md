...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/HealthRadar24/healthradar24/security/advisories/new) to submit your report directly through the repository.
...
HealthRadar24 is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- HealthRadar24 aggregates publicly available OSINT data
...
- Vulnerabilities in the HealthRadar24 codebase
