# Contributing to HealthRadar24

Thank you for your interest in contributing to HealthRadar24! This project thrives on community contributions — whether it's code, data sources, documentation, or bug reports.
...
HealthRadar24 is a real-time OSINT dashboard built with **Vanilla TypeScript** (no UI framework), **MapLibre GL + deck.gl** for map rendering, and a custom Proto-first RPC framework called **Sebuf** for all API communication.
...
- **Internationalization** — help make HealthRadar24 available in more languages
...
Use the [Bug Report issue template](https://github.com/HealthRadar24/healthradar24/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/HealthRadar24/healthradar24/issues/new/choose) when available.
...
Thank you for helping make HealthRadar24 better! 🌍
