...
describe('public product facts generation contract', () => {
  it('publishes generated lifecycle, pricing, and capability facts', () => {
    ...
    assert.equal(sharedFacts.product.name, 'HealthRadar24');
    assert.equal(sharedFacts.product.lifecycle, 'prelaunch');
    assert.equal(sharedFacts.product.canonicalUrl, 'https://www.healthradar24.com/');
    assert.equal(sharedFacts.product.pricingUrl, 'https://www.healthradar24.com/pro#pricing');
