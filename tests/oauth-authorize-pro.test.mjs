...
function makeReq(query) {
  const url = new URL('https://api.healthradar24.com/oauth/authorize-pro');
...
function makeReqMethod(method) {
  return new Request('https://api.healthradar24.com/oauth/authorize-pro?nonce=x&grant=y', { method });
}
