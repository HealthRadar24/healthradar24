...
export const PRO_LAUNCH_FROM = "Elie from WorldMonitor <news@healthradar24.com>";
export const PRO_LAUNCH_REPLY_TO = "elie@healthradar24.com";
...
export const PRO_LAUNCH_UPGRADE_URL =
  "https://healthradar24.com/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Elie, founder of WorldMonitor. PRO launched today (https://healthradar24.com/pro). I'm writing because you signed up a month ago, when the product was smaller and different.
...
It grew a dedicated energy variant. energy.healthradar24.com: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.
...
More than half of this didn't exist 45 days ago. The open-source repo (https://github.com/HealthRadar24/healthradar24) crossed 50,000 GitHub stars in the same window. That's the build pace.
...
Native AI context. MCP server plus a 27-endpoint REST API — full docs at https://healthradar24.com/docs/documentation. Plug it into Claude, ChatGPT, Cursor, or anything you're building.
...
→ Upgrade to PRO: https://healthradar24.com/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email
...
<p>I'm Elie, founder of WorldMonitor. <a href="https://healthradar24.com/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=opener" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
...
<p><strong>It grew a dedicated energy variant.</strong> <a href="https://energy.healthradar24.com" style="color:#0066cc;">energy.healthradar24.com</a>: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.</p>
...
<p>More than half of this didn't exist 45 days ago. The <a href="https://github.com/HealthRadar24/healthradar24" style="color:#0066cc;">open-source repo</a> crossed 50,000 GitHub stars in the same window. That's the build pace.</p>
...
<p><strong>Native AI context.</strong> MCP server plus a 27-endpoint REST API — <a href="https://healthradar24.com/docs/documentation" style="color:#0066cc;">full docs</a>. Plug it into Claude, ChatGPT, Cursor, or anything you're building.</p>
<p>Also included:</p>
...
<a href="https://healthradar24.com/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=cta-button" style="display:inline-block;background:#111;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;">Upgrade to PRO with EARLYWM30 →</a>
</p>
