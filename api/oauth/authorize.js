...
<body><a href="https://www.healthradar24.com" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card"><h1>${escapeHtml(title)}</h1><p>${escapeHtml(detail)}</p><a href="javascript:history.back()" class="back">&#8592; go back</a></div>
<p class="footer"><a href="https://www.healthradar24.com" target="_blank" rel="noopener">healthradar24.com</a></p>
...
export function consentPage(params, nonce, errorMsg = '') {
  ...
  const proCtaHref = `https://healthradar24.com/mcp-grant?nonce=${encodeURIComponent(nonce)}`;
...
<body>
<a href="https://www.healthradar24.com" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card">
<div class="client-hd">
...
<form id="cf" method="POST" action="https://api.healthradar24.com/oauth/authorize" style="display:none;margin-top:1.25rem">
...
<p class="hint">No key? <a href="https://www.healthradar24.com/pro" target="_blank" rel="noopener">Get one at healthradar24.com/pro &#x2192;</a></p>
<p class="error" id="ke"${errorMsg ? '' : ' style="display:none"'}>${errorMsg ? escapeHtml(errorMsg) : ''}</p>
<button type="submit" id="ab">Authorize</button>
</form>
</div>
<p class="footer"><a href="https://www.healthradar24.com" target="_blank" rel="noopener">healthradar24.com</a> &middot; <a href="https://www.healthradar24.com/pro" target="_blank" rel="noopener">Get an API key &#x2192;</a></p>
...
export default async function handler(req) {
  ...
  if (method === 'POST') {
    ...
    if (origin && origin !== 'https://api.healthradar24.com' && origin !== 'null') {
