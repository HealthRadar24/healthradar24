...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://healthradar24.com');
  ...
  const baseUrl = 'https://healthradar24.com';
  ...
  const title = `${countryName} Intelligence Brief | HealthRadar24`;
...
<head>
  ...
  <meta property="og:site_name" content="HealthRadar24"/>
