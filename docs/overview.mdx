...
description: "HealthRadar24 platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
HealthRadar24 runs six specialized variants from a single codebase, each optimized for different monitoring needs.

## Platform Variants

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 HealthRadar24** | [healthradar24.com](https://healthradar24.com) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.healthradar24.com](https://tech.healthradar24.com) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
| **😊 Happy Monitor** | [happy.healthradar24.com](https://happy.healthradar24.com) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.healthradar24.com](https://finance.healthradar24.com) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.healthradar24.com](https://commodity.healthradar24.com) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
| **⚡ Energy Monitor** | [energy.healthradar24.com](https://energy.healthradar24.com) | Oil & gas pipelines, storage facilities, tanker positions, chokepoints, energy infrastructure and shocks |
...
The tech variant ([tech.healthradar24.com](https://tech.healthradar24.com)) provides specialized layers for technology sector monitoring.
...
The finance variant ([finance.healthradar24.com](https://finance.healthradar24.com)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.healthradar24.com](https://commodity.healthradar24.com)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.healthradar24.com](https://happy.healthradar24.com)) curates positive news, human progress data, and uplifting stories.
