---
title: "License"
description: "HealthRadar24 licensing terms: AGPL-3.0-only code license, optional commercial licensing, and trademark policy separation."
---

HealthRadar24 source code is licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0-only)](https://www.gnu.org/licenses/agpl-3.0.html).

This page is a plain-language summary for contributors and users. It is not legal advice and does not replace the license text in [`LICENSE`](https://github.com/HealthRadar24/healthradar24/blob/main/LICENSE).
...
- use HealthRadar24 for personal, educational, research, nonprofit, or commercial purposes
...
- combine HealthRadar24 code into proprietary products in ways the AGPL would not permit
...
Contact the maintainer through the [GitHub repository](https://github.com/HealthRadar24/healthradar24) to discuss commercial licensing.

## Trademark and branding

The AGPL covers copyright permissions for the code. It does not grant rights to use the HealthRadar24 name, logo, visual identity, or official project branding.
...
**Using HealthRadar24's public API in your own tool**: API terms of service may apply separately from the source-code license.
