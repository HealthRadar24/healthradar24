...
description: "How HealthRadar24 classifies and publishes fuel shortage alerts (jet, petrol, diesel, heating oil) using an automated evidence-threshold pipeline."
---
...
[GitHub issues](https://github.com/HealthRadar24/healthradar24/issues); they
...
today via [GitHub issues](https://github.com/HealthRadar24/healthradar24/issues).
