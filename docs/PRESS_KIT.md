...
HealthRadar24 runs six thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **HealthRadar24** | healthradar24.com | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.healthradar24.com | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.healthradar24.com | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.healthradar24.com | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.healthradar24.com | Good news, conservation, positive global trends |
| **Energy Monitor** | energy.healthradar24.com | Energy security, oil and gas, chokepoints, policy response |

### AI Intelligence Layer

HealthRadar24 uses a multi-tier AI pipeline to process and summarize information:
...
HealthRadar24 aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
HealthRadar24 serves several audiences:
...
| Feature | HealthRadar24 | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at healthradar24.com and variant subdomains
...
HealthRadar24 is actively developed with planned expansions across several areas:
...
- **API and MCP access** for developers and organizations to integrate HealthRadar24 data into their own tools
...
**Q: Where does HealthRadar24 get its data?**
...
**Q: Does HealthRadar24 track users or sell data?**
...
A: Yes. HealthRadar24 is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: HealthRadar24 was created by Elie Habib. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed HealthRadar24 or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, use the documented REST API, OpenAPI specs, or MCP server. Please attribute "HealthRadar24 (healthradar24.com)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. HealthRadar24 aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: HealthRadar24 is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/HealthRadar24/healthradar24
- **Website**: healthradar24.com

---

*This document was last updated March 2026. HealthRadar24 is an independent, open-source project licensed under AGPL-3.0.*
