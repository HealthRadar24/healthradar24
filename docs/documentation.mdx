...
HealthRadar24 is open source under [AGPL-3.0-only](/license). Commercial use is permitted under the AGPL when you comply with its copyleft and source-availability terms. Separate commercial licensing is available as an alternative option for private-source or custom contractual terms.
