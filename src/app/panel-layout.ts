  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open(getProUrl(), '_blank', 'noopener,noreferrer');
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">HEALTHRADAR24</span><span class="logo-mobile">${PRODUCT_BRAND.name}</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <span class="credit-link" title="A Kernelius project built on the open-source WorldMonitor platform">
            <span class="credit-text">by ${PRODUCT_BRAND.company}</span>
          </span>
          <a href="${PRODUCT_BRAND.repository}" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          <a href="${getProUrl()}" target="_blank" rel="noopener">Pro</a>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">${PRODUCT_BRAND.shortName}</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; a ${PRODUCT_BRAND.company} project</span>
          </div>
        </div>
        <nav>
          <a href="${getProUrl()}" target="_blank" rel="noopener">Pro</a>
          <a href="${PRODUCT_BRAND.supportPath}">Support</a>
          <a href="${PRODUCT_BRAND.repository}" target="_blank" rel="noopener">GitHub</a>
          <a href="${PRODUCT_BRAND.upstreamRepository}" target="_blank" rel="noopener">Upstream</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} ${PRODUCT_BRAND.company}</span>
      </footer>
