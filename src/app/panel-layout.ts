  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://healthradar24.com/pro', '_blank');
      default:
        return () => {};
    }
  }
  ...
  async renderLayout(): Promise<void> {
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://healthradar24.com')}"
            ...
            <a href="${vHref('tech', 'https://tech.healthradar24.com')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.healthradar24.com')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.healthradar24.com')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', 'https://energy.healthradar24.com')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.healthradar24.com')}"
          ...
          <span class="logo">HEALTHRADAR24</span><span class="logo-mobile">HealthRadar24</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/HealthRadar24/healthradar24" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">HEALTHRADAR24</span>
        ...
        <div class="mobile-menu-footer-links">
          <a href="${this.ctx.isDesktopApp ? 'https://healthradar24.com/pro' : 'https://www.healthradar24.com/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://healthradar24.com/blog/' : 'https://www.healthradar24.com/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://healthradar24.com/docs' : 'https://www.healthradar24.com/docs'}" target="_blank" rel="noopener">Docs</a>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">HEALTHRADAR24</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="${__BUILD_HASH__ === 'dev' ? 'https://github.com/HealthRadar24/healthradar24' : `https://github.com/HealthRadar24/healthradar24/commit/${__BUILD_HASH__}`}" target="_blank" rel="noopener" class="site-footer-credit">source ${__BUILD_HASH__ === 'dev' ? 'main' : __BUILD_HASH__.slice(0, 7)}</a></span>
          </div>
        </div>
        <nav>
          <a href="${this.ctx.isDesktopApp ? 'https://healthradar24.com/pro' : 'https://www.healthradar24.com/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://healthradar24.com/blog/' : 'https://www.healthradar24.com/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://healthradar24.com/docs' : 'https://www.healthradar24.com/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://github.com/HealthRadar24/healthradar24" target="_blank" rel="noopener">GitHub</a>
          <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener">Based on World Monitor</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} HealthRadar24</span>
      </footer>
