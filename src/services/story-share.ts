...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via HealthRadar24 — health, life-science and global risk intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - HealthRadar24`)}`,
