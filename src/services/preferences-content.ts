...
const DESKTOP_RELEASES_URL = 'https://github.com/HealthRadar24/healthradar24/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://github.com/HealthRadar24/healthradar24/discussions" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
