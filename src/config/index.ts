...
// VITE_VARIANT=tech → tech.healthradar24.com (tech-focused)
// VITE_VARIANT=full → healthradar24.com (geopolitical)
// VITE_VARIANT=finance → finance.healthradar24.com (markets/trading)
